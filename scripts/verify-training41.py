...
slug = 'tiktok-shop-product-readiness-content-creators-paid-scale'
date = '2026-09-17'
...
prior = ['tiktok-shop-listing-discovery-strategy', 'tiktok-shop-search-shop-tab-content-discovery', 'tiktok-shop-creator-live-brand-system', 'tiktok-shop-creator-merchant-content-growth-stage', 'tiktok-shop-merchant-content-compounding-system', 'tiktok-shop-video-photo-live-content-job']
...
previous_slug = 'tiktok-shop-listing-discovery-strategy'
...
checks['previous_day_route'] = 'Your Listing Is Not Your Discovery Strategy' in previous_source
checks['previous_day_schema_date'] = len(previous_posts) == 2 and all(n.get('datePublished') == '2026-09-16' for n in previous_posts)
checks['previous_day_sitemap'] = f'<loc>{base}/blog/{previous_slug}</loc><lastmod>2026-09-16</lastmod>' in get('/sitemap.xml').decode()
