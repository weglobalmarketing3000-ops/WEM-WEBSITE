...
slug = 'tiktok-shop-search-shop-tab-content-discovery'
date = '2026-09-15'
...
prior = ['tiktok-shop-creator-live-brand-system', 'tiktok-shop-creator-merchant-content-growth-stage', 'tiktok-shop-merchant-content-compounding-system', 'tiktok-shop-video-photo-live-content-job', 'tiktok-shop-short-video-localization-us-shoppers', 'tiktok-shop-live-control-room']
...
previous_slug = 'tiktok-shop-creator-live-brand-system'
...
checks['previous_day_route'] = 'Turn Creator LIVE Into a Brand System' in previous_source
checks['previous_day_schema_date'] = len(previous_posts) == 2 and all(n.get('datePublished') == '2026-09-14' for n in previous_posts)
checks['previous_day_sitemap'] = f'<loc>{base}/blog/{previous_slug}</loc><lastmod>2026-09-14</lastmod>' in get('/sitemap.xml').decode()
