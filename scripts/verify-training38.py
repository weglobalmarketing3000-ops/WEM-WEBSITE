...
slug = 'tiktok-shop-creator-live-brand-system'
date = '2026-09-14'
...
prior = ['tiktok-shop-creator-merchant-content-growth-stage', 'tiktok-shop-merchant-content-compounding-system', 'tiktok-shop-video-photo-live-content-job', 'tiktok-shop-short-video-localization-us-shoppers', 'tiktok-shop-live-control-room', 'tiktok-shop-live-auction-economics']
...
previous_slug = 'tiktok-shop-creator-merchant-content-growth-stage'
...
checks['previous_day_route'] = 'Creator Content, Merchant Content or Both?' in previous_source
checks['previous_day_schema_date'] = len(previous_posts) == 2 and all(n.get('datePublished') == '2026-09-13' for n in previous_posts)
checks['previous_day_sitemap'] = f'<loc>{base}/blog/{previous_slug}</loc><lastmod>2026-09-13</lastmod>' in get('/sitemap.xml').decode()
