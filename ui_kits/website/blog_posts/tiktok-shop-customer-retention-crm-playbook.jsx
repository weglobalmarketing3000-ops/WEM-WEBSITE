...
const POSTS = {
    ...
    sections: [
      {
        ...
        body: [
          ...
          INFO('tiktok-shop-crm-first-order-flow.svg', 'Four-stage WEM operating flow from creator discovery to first order, CRM message, and repeat purchase', 'A useful CRM message creates the next relevant customer moment instead of broadcasting another promotion.'),
          UL([
  ...
  zh: {
    ...
    sections: [
      {
        id: '直接答案', eyebrow: '用户留存', h: '很多品牌缺的不是发消息的工具，而是用户下一次回来的理由', body: [
          ...
          INFO('tiktok-shop-crm-first-order-flow-zh.svg', '从达人发现、完成首单、CRM 触达到用户复购的 WEM 四阶段运营流程', '一条真正有用的 CRM 消息，应该创造用户下一个相关行动，而不是再广播一次促销。'),
      ...
      {
        id: '首单不是终点', eyebrow: '运营洞察', h: '首单不是终点，而是关系刚刚开始', body: [
      ...
      {
        id: '美国市场差异', eyebrow: '用户生命周期', h: '美国市场的差距，往往发生在成交之后', body: [
      ...
      {
        id: '留存闭环', eyebrow: 'WEM 运营框架', h: 'WEM 用户留存闭环：把达人、首单和复购接起来', body: [
      ...
      {
        id: '达人和crm', eyebrow: '达人质量', h: '达人团队和 CRM 团队不能各做各的', body: [
      ...
      {
        id: '活动架构', eyebrow: '活动设计', h: '先搭一个小而清楚的活动架构', body: [
      ...
      {
        id: '官方边界', eyebrow: '平台规则', h: 'CRM 权限不是一个按钮，而是店铺基本功的结果', body: [
      ...
      {
        id: '本地化', eyebrow: '本地化运营', h: '本地化不是翻译，而是重写关系理由', body: [
      ...
      {
        id: '30天', eyebrow: '30 天计划', h: '一个可执行的 30 天启动方案', body: [
      ...
      {
        id: 'wem作用', eyebrow: '为什么选择 WEM', h: 'WEM 在这套系统里的作用', body: [
      ...
      {
        id: '来源', eyebrow: '来源说明', h: '来源与边界', body: [
