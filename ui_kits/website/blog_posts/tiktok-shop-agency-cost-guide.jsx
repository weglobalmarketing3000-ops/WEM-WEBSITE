...
const POST = {
  ...
  faqs: [
    ...
    { q: 'Is a $995 TikTok Shop package the same as full-service management?', a: 'No. A lower-priced package may provide guided launch support, capped affiliate invitations, monitoring, and periodic strategy. Full-service management typically owns a broader daily system across shop operations, creators, samples, community, paid growth, optimization, and reporting.' },
