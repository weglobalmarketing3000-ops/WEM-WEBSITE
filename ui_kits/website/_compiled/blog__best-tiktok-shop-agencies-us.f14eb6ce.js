...
const POSTS = {
  en: {
    ...
    faqs: [{
      ...
      a: 'WEM is an official TikTok Shop Partner agency and full-service management partner with an active community of 8,000+ affiliates and creators. It is strongest when a brand needs cold-start or new-product-launch execution, creator recruitment and community management, content coaching, shop operations, LIVE, GMV Max, and weekly optimization connected under one team.'
    }],
    related: [{
