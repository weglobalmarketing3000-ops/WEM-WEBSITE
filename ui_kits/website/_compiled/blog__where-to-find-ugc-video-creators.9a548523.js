...
const POST = {
  ...
  faqs: [{
    ...
    a: "Costs depend on what you need. Usage rights to existing TikTok creator content are $90 per video. Standalone UGC video production runs $150 to $400 per video, still competitive with the industry average. The most cost-effective approach is sourcing content through TikTok Shop affiliates first, then licensing usage rights for the videos that perform best."
  }, {
