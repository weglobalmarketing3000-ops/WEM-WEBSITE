...
function App() {
  ...
  useEffect(() => {
    ...
    document.querySelector('meta[name="description"]').setAttribute('content', lang === 'zh' ? 'WEM 是位于南加州的美国 TikTok Shop 服务机构，为品牌、跨境卖家和 Amazon 团队提供店铺运营、达人联盟、UGC 和直播支持。' : 'WEM is a Southern California TikTok Shop agency helping U.S. and cross-border brands with shop operations, creator affiliates, UGC, and live selling.');
  }, [lang]);
  useEffect(() => {
