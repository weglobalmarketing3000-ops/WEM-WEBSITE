...
const CASES = [
  ...
  },
  {
    ...
    tag_zh: '达人联盟冷启动 · 男装',
    title_en: 'From One Hero SKU\nto a Higher-Value Assortment.',
    title_zh: '从一个 Hero SKU\n到更高价值的产品组合',
    body_en: 'After six months of limited TikTok Shop traction, WE Marketing established ANANKECLO’s Cuban shirt, at approximately $35 AOV, as the lead-in hero SKU. The team expanded creator recruitment, optimized the listing, and tested free-shipping and gift-with-purchase offers before extending the assortment to sweatpants at approximately $60 AOV.',
    body_zh: 'ANANKECLO 在 TikTok Shop 上线六个月后仍未建立稳定增长。WE Marketing 以客单价约 35 美元的 Cuban shirt 作为首个 Hero SKU，集中拓展达人招募、优化商品页，并测试包邮与赠品 Offer。路径验证后，品牌再扩展到客单价约 60 美元的 sweatpants。',
    stats_en: [
      { kind: 'num', num: 10000, suffix: '+', label: 'Orders after relaunch' },
      { kind: 'num', num: 5.1,   suffix: 'M', label: 'Views on one hero video', decimals: 1 },
      { kind: 'check', label: 'Broader creator recruitment\nacross audience segments' },
      { kind: 'check', label: 'Creator-led validation\nbefore paid expansion' },
    ],
    stats_zh: [
      { kind: 'num', num: 10000, suffix: '+', label: '重启后订单数' },
      { kind: 'num', num: 5.1,   suffix: 'M', label: '单条视频播放', decimals: 1 },
      { kind: 'check', label: '拓展达人组合\n覆盖更多受众' },
      { kind: 'check', label: '先验证达人内容\n再扩大投放' },
    ],
    pull_en: 'Fashion assortment expansion should follow a validated acquisition and conversion path.',
    pull_zh: '服装扩品应建立在已经验证的获客与转化路径上。',
