...
const WorkHero = ({ lang }) => {
  const t = {
    en: {
      pill: 'OUR WORK',
      h1a: 'TikTok Shop growth.',
      h1accent: 'Proven with brands.',
      sub: 'Brand and seller case studies across beauty, wellness, tech, and fashion: cold starts, creator affiliates, live programs, operating changes, and real sales metrics.',
    },
    zh: {
      pill: '案例',
      h1a: '美国 TikTok Shop',
