...
const CtaFooter = ({ lang }) => {
  const t = {
    ...
    ko: { h: 'TikTok에서\n성장할 준비가 되셨나요?', sub: '브랜드와 현재 운영 환경, 이루고 싶은 목표를 알려주세요. 24시간 이내에 답변드리겠습니다.', cta: '상담 예약하기 →', alt: '이메일로 문의하기', href: 'https://zus03h0enw04.sg.larksuite.com/scheduler/03970278dd9a7925' },
  }[lang];
  return (
...
const ctaStyles = {
  ...
  bg: { position: 'absolute', inset: '-10%', background: 'radial-gradient(circle at 50% 50%, rgba(155,48,255,.2) 0%, transparent 58%), radial-gradient(circle at 15% 80%, rgba(74,143,255,.24), transparent 38%)', pointerEvents: 'none', animation: 'cta-bg-shift 12s ease-in-out infinite' },
